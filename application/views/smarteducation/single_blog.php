                ...
                <div class="col-lg-9 blog-post-single">
                    <div class="blog-item">
						<div class="image-blog">
							...
							<img src="<?php echo base_url(); ?>images/<?php echo $abc->image ; ?>" alt="" type="image/x-icon" />
						...
						<div class="post-content">
							...
							<div class="meta-info-blog">
								...
								<span><i class="fa fa-comments"></i> <?php echo $abc->authore_name; ?> </span>
							</div>
							<div class="blog-title">
							<h2><a href="#" title=""><?php echo $abc->title; ?> </a></h2>
							</div>
							<div class="blog-desc">

							<p> <?php echo $abc->discription ?></p>
