            ...
            <table id="example2" class="table table-hover">
              ...
              <?php foreach($user as $users): 
                ...
                <tr>
                 ...
                 <td><a href="<?php echo base_url('admin/Crude/edit/'.$users->id); ?>" class="fas fa-pen"   onclick=" return confirm('do you want to realy adit?')"> </a>
                 <a href="<?php echo base_url('admin/Crude/delete/'.$users->id); ?>"  class="fas fa-trash-alt" onclick="return confirm('Do you really want to leave?')"></a>
               </tr>
               <?php 
             endforeach;
           endif; ?>
