    ...
    <div class="col-md-6">
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Update Servecess form</h3>
        </div>
        <?php
        if (isset($error)){
          echo $error;
        ...
        <form action="<?php echo base_url() ?>admin/Crude/update_about" method="POST"  enctype="multipart/form-data">
          <div class="card-body">
          ...
          <input type="text" class="form-control" name="about" value="<?php echo $getdata->about;?>" placeholder="Enter contact">
            <?php  if(form_error('about'))
            {
             echo "<span style='color:red'>".form_error('about')."</span>";
           }
           ?> 
         </div>
