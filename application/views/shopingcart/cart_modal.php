  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo site_url('shopingcart/Shopingcart/billing_view') ?>"><button type="button" class="btn btn-primary">Place Order</button></a>
      </div>
    </div>
  </div>
</div>
...
if (answer)
{
        $.ajax({
                type: "POST",
                url: "<?php echo site_url('shopingcart/Shopingcart/remove');?>",
                data: "rowid="+rowid,
...
var subtotal = $('.subtotal'+rowid).text();
    $.ajax({
            type: "POST",
            url: "<?php echo site_url('shopingcart/Shopingcart/update_cart');?>",
