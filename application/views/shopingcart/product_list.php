...
-->                <li class="nav-item menu-open">
  <a href="<?php echo base_url(); ?>shopingcart/Shopingcart/product_create" class="nav-link ">
            ...
            <table id="example2" class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><a href="<?php echo base_url('shopingcart/Shopingcart/product_edit/'.$users->id); ?>" class="fas fa-pen"   onclick=" return confirm('do you want to realy adit?')"> </a>
                   <a href="<?php echo base_url('shopingcart/Shopingcart/product_delete/'.$users->id); ?>"  class="fas fa-trash-alt" onclick="return confirm('Do you really want to leave?')"></a>
                 </tr>
                 <?php 
                 endforeach;
                 endif; ?>
