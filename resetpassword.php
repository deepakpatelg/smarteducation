     ...
     public function resetlink(){
        ...
        $result = $this->Forgot_model->resetlink($email);
          ...
          if (count($result)>0)
          {
             ...
             $message = "Please click reset password link <br> <a href='". base_url('index.php/forgotpassword/reset?tokan=').$tokan."'>Reset Password</a>";
        ...
        $this->email->initialize($config);
          ...
          else
          {
               ...
               redirect(base_url().'index.php/forgotpassword/forgot','refresh');
